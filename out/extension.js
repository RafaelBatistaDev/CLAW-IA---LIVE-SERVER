...
function activate(context) {
    ...
    let startServer = vscode.commands.registerCommand('claw.startServer', async () => {
        ...
        if (currentPanel) {
            ...
            currentPanel = vscode.window.createWebviewPanel('clawPreview', `🚀 CLAW Preview: ${langId.toUpperCase()}`, vscode.ViewColumn.Two, { enableScripts: true });
...
function getWebviewContent(url, lang, fileName) {
    return `<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
